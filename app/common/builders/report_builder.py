from ...repositories.models import Report
...
class ReportBuilder:
    ...
    def with_month_with_most_revenue(self, 
                                    month_with_most_revenue: str) -> 'ReportBuilder':
        self.report_data['month_with_most_revenue'] = month_with_most_revenue
        return self

    def with_sales_in_month_with_most_revenue(self, 
                                            sales_most_revenue: int) -> 'ReportBuilder':
